...
export default function DashboardPage() {
  ...
  // Instancia Esqueleto ERP: solo Ventas / Inventario / Financiero (sin Comercial/CRM/Pipeline).
      ...
      <header className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-1 max-w-md text-sm leading-relaxed" style={{ color: Z.muted }}>
              Esqueleto ERP · Vista {nivel === "supervisor" ? "de tu área" : "global"} · período alineado al filtro
            </p>
          </div>
        </div>

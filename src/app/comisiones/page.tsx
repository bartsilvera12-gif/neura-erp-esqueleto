  ...
  return (
    <div className="overflow-x-auto">
      <table className="mt-3 w-full min-w-[980px] text-left text-sm">
        <thead>
          <tr className="zx-thead text-xs uppercase text-slate-500">
...
function renderVendedorView({
  ...
  return (
    <div className="mx-auto max-w-5xl space-y-6 overflow-hidden px-4 py-10">
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          ...
          <label className="block text-left">
            ...
            <input
              ...
              className="zx-surface mt-1 block px-3 py-2 text-sm font-semibold text-slate-800 outline-none transition focus:border-sky-400 focus:ring-2 focus:ring-sky-100"
            />
          </label>
        </div>
      </section>
      ...
      {!sellerRow ? (
        <div className="zx-surface px-4 py-10 text-center">
        ...
        <>
          ...
          <details className="zx-surface group open:shadow-md">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            type="button"
            onClick={onReload}
            className="zx-surface inline-flex items-center gap-2 px-4 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50"
          >
          ...
          <Link
            ...
            className="zx-surface inline-flex items-center px-4 py-2 text-sm font-semibold text-slate-800 hover:bg-slate-50"
          >
            Configuración
          </Link>
        </div>
          ...
          <div className="space-y-3">
            {rows.map((r) => (
              <details
                ...
                className="zx-surface group open:shadow-md"
              >

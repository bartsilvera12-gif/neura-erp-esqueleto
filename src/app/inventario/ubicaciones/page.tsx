...
// ABM de Depósitos/Ubicaciones ACTIVO en Esqueleto ERP: el módulo Inventario se
// habilita completo (productos, movimientos, categorías y depósitos/ubicaciones).

    ...
    <div ref={containerRef} className="relative">
      ...
      <div className="relative">
        <input
          ...
          disabled={disabled}
          className="zx-surface w-full px-3 py-2 pr-9 outline-none focus:ring-2 focus:ring-[#0EA5E9] focus:outline-none text-sm disabled:bg-slate-50 disabled:cursor-not-allowed"
        />
      ...
      {/* Lista desplegable */}
      {abierto && (
        <div className="zx-surface absolute z-10 mt-1 w-full shadow-lg max-h-56 overflow-y-auto">
          {filtrados.length === 0 ? (
